...
**[tariffs-response-jamtkraft.json](tariffs-response-jamtkraft.json)**
...
**[tariffs-response_HEM.json](tariffs-response_HEM.json)**
...
**[tariffs-response_DE.json](tariffs-response_DE.json)** (Dala Energi)
...
**[tariffs-response_goteborg-energi.json](tariffs-response_goteborg-energi.json)**
...
**[tariffs-response.json](tariffs-response.json)** (Dynamiskt timpris)
...
**[prices-response.json](prices-response.json)**
